...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "tushargagal1209@gmail.com",
...
exports.cookieExtractor = function (req) {
  ...
  token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2MWNlZjAwNmNmNzAyZGY1MWZkMzM0OSIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTcxNjcwNzA5MH0.QN5-z-8rWFxR4kUpUpUyFKrcCTCzCue8Fqal_TFn9CU";
  // token =
  //   "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2NDFmZjVlMzVhZjE0N2Q0OTM4MWJiZCIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzE2NzA4Mzc2fQ.cdDY4A_CXEDESi7rLgKassMIeemkr2lEMJKpchbbPcE";
  return token;
};
...
exports.sendMail = async function ({ to, subject, text, html }) {
  const info = await transporter.sendMail({
    from: '"CartEase" <tushargagal1209@gmail.email>', // sender address
...
exports.invoiceTemplate = function (order) {
            ...
            <tr>
              <td align="center" valign="top" style="padding: 36px 24px;">
                <a href="" target="_blank" style="display: inline-block;">
                  <img src="../logo (2).png" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                </a>
              </td>
            </tr>
          </table>
              ...
              <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td align="left" width="60%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"></td>
                    <td align="left" width="20%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>RS ${
                      order.totalAmount
                    }</strong></td>
                  </tr>
                </table>
  ...
  }<br>${order.selectedAddress.street}<br>${order.selectedAddress.city}<br>${
